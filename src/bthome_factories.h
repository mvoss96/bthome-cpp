...
{
    // Scalar measurements
    inline Measurement packet_id(uint8_t v) { return detail::u<MiscObjectId::PacketId>(v); }
    inline Measurement battery(uint8_t pct) { return detail::u<SensorObjectId::Battery>(pct); }
    ...
    inline Measurement count(uint8_t v) { return detail::u<SensorObjectId::Count>(v); }
    ...
    inline Measurement humidity_u8(uint8_t pct) { return detail::u<SensorObjectId::HumidityU8>(pct); }
    inline Measurement moisture_u8(uint8_t pct) { return detail::u<SensorObjectId::MoistureU8>(pct); }
    inline Measurement count_u16(uint16_t v) { return detail::u<SensorObjectId::CountU16>(v); }
    inline Measurement count_u32(uint32_t v) { return detail::u<SensorObjectId::CountU32>(v); }
    ...
    inline Measurement timestamp(uint32_t epoch_s) { return detail::u<SensorObjectId::Timestamp>(epoch_s); }
    ...
    inline Measurement temperature_s8(int8_t c) { return detail::s<SensorObjectId::TemperatureS8>(c); }
    inline Measurement temperature_s8_035(float c) { return detail::make_sensor<SensorObjectId::TemperatureS8_035>(c); }
    inline Measurement count_s8(int8_t v) { return detail::s<SensorObjectId::CountS8>(v); }
    inline Measurement count_s16(int16_t v) { return detail::s<SensorObjectId::CountS16>(v); }
    inline Measurement count_s32(int32_t v) { return detail::s<SensorObjectId::CountS32>(v); }
    ...
    inline Measurement channel(uint8_t v) { return detail::u<SensorObjectId::Channel>(v); }
    ...
    inline Measurement light_level(uint8_t v) { return detail::u<SensorObjectId::LightLevel>(v); }
    inline Measurement settings_revision(uint8_t v) { return detail::u<SensorObjectId::SettingsRevision>(v); }
    ...
    {
        return detail::u<EventObjectId::ButtonEvent>(static_cast<uint8_t>(e));
    }
    ...
    {
        constexpr uint8_t id = detail::oid(EventObjectId::DimmerEvent);
    ...
    // Device objects
    inline Measurement device_type_id(uint16_t v) { return detail::u<DeviceObjectId::DeviceTypeId>(v); }
    inline Measurement firmware_version_u32(uint32_t v) { return detail::u<DeviceObjectId::FirmwareVersionU32>(v); }
    inline Measurement firmware_version_u24(uint32_t v) { return detail::u<DeviceObjectId::FirmwareVersionU24>(v); }
